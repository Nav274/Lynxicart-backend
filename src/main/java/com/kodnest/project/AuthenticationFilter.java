...
public class AuthenticationFilter implements Filter {
	...
	private static final String[] UNAUTHENTICATED_PATHS = { "/api/register", "/api/login", "/forgotpass/emailauth", "/forgotpass/verifyotp", "/forgotpass/changepass" };


	public AuthenticationFilter(LoginService authService, UserRepository userRepository) {
	...
	private void executeFilterLogic(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		int ID = authenticatedUser.getUser_id();
		logger.info("Authenticated User: {}, Role: {}, ID:{}" ,authenticatedUser.getUsername(), role, ID);
